...
import "./IEigerSwap.sol";

contract EigerSwap is IEigerSwap, PausableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  function __eiger_swap_init(address _swapRouterAddress, address _wethAddress) public initializer {
    __Ownable_init();
    __Pausable_init();
